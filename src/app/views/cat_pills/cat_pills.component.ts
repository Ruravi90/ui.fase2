...
@Component({
  selector: 'app-cat-pills',
  standalone: true,
  imports: [CommonModule, FormsModule, PaginationModule],
  templateUrl: './cat_pills.component.html'
})
export class CatPillsComponent implements OnInit {
  ...
  deleteItem(_item: _Type) {
    Swal.fire({
      ...
      html: `<p style="color:#555;font-size:0.95rem">Se eliminará la pastilla <strong>${_item.name}</strong>. Esta acción no se puede deshacer.</p>`,
      icon: 'warning',
      reverseButtons: true,
